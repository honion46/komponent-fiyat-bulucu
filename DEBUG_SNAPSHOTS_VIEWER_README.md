...
2) Ya da repository yapısına göre bir route/page ekleyip doğrudan entegre edebilirim — hangi router/SSG çerçevesini kullandığınızı belirtin veya bunu benim seçmemi isterseniz Next.js varsayımsıyla bir sayfa ekleyebilirim.
